define(['angular'], function (angular) {
    ...
    var utilitiesProvider = angular.module("utilities.provider", ["utilities.provider.modal"])
    /**
     * 通过provider形式实现的事件总线，用于跨域的事件传递
     * Angular自带的事件广播机制不具备定向点对点的广播机制，会影响性能
     * 事件广播路径较长的场景可使用此总线
     * 通过angular服务与发布订阅设计模式结合实现此功能
     */
        .provider('eventBus', function () {
            var events = [];
    ...
    angular.module('utilities.provider.transition', [])
    ...
    angular.module('utilities.provider.modal', ['utilities.provider.transition'])
        ...
        .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
            return {
                ...
                templateUrl: function (tElement, tAttrs) {
                    return tAttrs.templateUrl || 'template/service/window.html';
                },
                link: function (scope, element, attrs) {
